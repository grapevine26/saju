...
const SERVICES = [
    ...
    },
    {
        ...
        glow: 'rgba(201,161,92,0.15)',
        cardBg: 'linear-gradient(150deg, rgba(38,32,20,0.75) 0%, rgba(14,12,9,0.85) 60%)',
    ...
    if (type === 'seal') {
        return (
            <div style={{ position: 'relative', width: 74, height: 62, display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 6 }}>
                <div style={{
                    width: 38, height: 38, border: '2px solid #B8B4BE', color: '#B8B4BE', borderRadius: 6,
                    display: 'flex', alignItems: 'center', justifyContent: 'center',
                    fontFamily: "'Noto Serif KR', serif", fontSize: 17, fontWeight: 900,
                    transform: 'rotate(-6deg)', boxShadow: `0 0 14px rgba(184,180,190,0.18)`,
                }}>合</div>
                <div style={{
                    ...
                    boxShadow: '0 0 14px rgba(217,184,114,0.22)',
                }}>緣</div>
            </div>
        );
    }
