...
const SERVICES = [
    ...
    },
    {
        ...
        badge: '첫 리딩 무료',
        accent: '#9D7BFF',
        accentSoft: 'rgba(157,123,255,0.12)',
        border: 'rgba(157,123,255,0.30)',
        glow: 'rgba(124,77,255,0.18)',
        cardBg: 'linear-gradient(150deg, rgba(21,13,48,0.80) 0%, rgba(7,5,16,0.85) 60%)',
        ...
        <div style={{ position: 'relative', width: 74, height: 62 }}>
            {[-18, 0, 18].map((deg, i) => (
                <div key={i} style={{
                    ...
                    background: 'linear-gradient(160deg, #170D33 0%, #1F1240 100%)',
