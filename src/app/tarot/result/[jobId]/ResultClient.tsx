                ...
                {special && (
                    ...
                    >
                        ...
                        <div style={{
                            ...
                            <div style={{
                                height: 6, borderRadius: 3, background: 'rgba(167,139,250,0.12)',
                        ...
                        {[
                            ...
                            <div key={i} style={{
                                ...
                                <p style={{
                                    fontSize: 13, color: 'rgba(240,234,252,0.88)', lineHeight: 1.85,
