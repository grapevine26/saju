...
export default function TarotSelectPage() {
                    ...
                    <div style={{ display: 'flex', flexDirection: 'column', gap: 10, width: '100%', maxWidth: 320 }}>
                        <button
                            ...
                            style={{
                                ...
                                background: 'rgba(76,40,137,0.3)', color: 'var(--tarot-accent-light)',
    ...
    if (phase === 'loading') {
        const roundColors = [
            { border: 'rgba(196,181,253,0.9)',  glow: 'rgba(196,181,253,0.4)',  label: '과거' },
            { border: 'rgba(167,139,250,0.9)', glow: 'rgba(167,139,250,0.4)', label: '현재' },
            { border: 'rgba(240,234,252,0.95)', glow: 'rgba(240,234,252,0.35)', label: '미래' },
        ];
                ...
                <div style={{ position: 'relative', width: 76, height: 76, display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                    <motion.div
                        ...
                        style={{
                            ...
                            background: 'radial-gradient(circle, rgba(167,139,250,0.4) 0%, transparent 72%)',
                            filter: 'blur(6px)',
                        }}
                    />
                    <div style={{
                        position: 'relative', width: 60, height: 60, borderRadius: '50%',
                        background: 'linear-gradient(135deg, rgba(91,33,182,0.35), rgba(76,40,137,0.5))',
