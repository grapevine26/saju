...
/* ── 팔레트 상수 (#0A0614 → #150D30 → #311C63 → #A78BFA → #F0EAFC) ── */
const P    = "rgba(167,139,250,";   // lavender
const DP   = "rgba(76,40,137,";     // dark purple
const NP   = "rgba(139,92,246,";    // neon purple
const LAV  = "#A78BFA";
const BLUSH = "#F0EAFC";
const GOLD  = "#C4B5FD";
const GOLD_D = "rgba(196,181,253,";

/* ── 글래스카드 스타일 헬퍼 ── */
function glass(extra?: React.CSSProperties): React.CSSProperties {
    return {
        background: "rgba(21,13,48,0.45)",
                ...
                <svg width="160" height="96" viewBox="0 0 160 96" fill="none">
                    <defs>
                        ...
                        <radialGradient id="mg2" cx="32%" cy="32%" r="75%">
                            <stop offset="0%"  stopColor="#F0EAFC" />
                            <stop offset="32%" stopColor="#C4B5FD" />
                    ...
                    {/* 은은한 크레이터 텍스처 */}
                    <circle cx="58" cy="42" r="2.2" fill="#4C2889" opacity="0.28" mask="url(#moon-mask)" />
                    <circle cx="64" cy="58" r="1.4" fill="#4C2889" opacity="0.24" mask="url(#moon-mask)" />
                    <circle cx="52" cy="55" r="1.6" fill="#4C2889" opacity="0.2" mask="url(#moon-mask)" />
...
function TarotCardMini() {
    return (
        <div style={{
            width:60, height:96,
            borderRadius:11,
            background:"linear-gradient(155deg, #241549 0%, #150D30 100%)",
...
function MockLine({ w, strong }: { w: string | number; strong?: boolean }) {
    return (
        <div style={{
            ...
            background: strong ? "rgba(240,234,252,0.45)" : "rgba(240,234,252,0.22)",
        }} />
    );
}
                        ...
                        <div style={blurWrap}>
                            <div style={{ display: "flex", gap: 8, alignItems: "center", marginBottom: 10 }}>
                                <div style={{
                                    ...
                                    background: "linear-gradient(155deg, #311C63, #150D30)",
                                ...
                                <div style={{ flex: 1 }}>
                                    ...
                                    <div style={{
                                        ...
                                        background: "rgba(124,58,237,0.2)", border: `1px solid ${P}0.3)`,
                ...
                <div>
                    <div style={panelStyle}>
                        <div style={{ ...blurWrap, textAlign: "center" }}>
                            ...
                            <div style={{
                                height: 5, borderRadius: 3, background: "rgba(167,139,250,0.15)",
                                overflow: "hidden", margin: "0 8px 12px",
                            }}>
                                <div style={{ height: "100%", width: "82%", borderRadius: 3, background: `linear-gradient(90deg, #5B21B6, ${LAV}, ${GOLD})` }} />
                            </div>
    ...
    return (
        <div style={{ ...glass({ borderRadius:14 }), overflow:"hidden" }}>
            <button onClick={()=>setOpen(o=>!o)} style={{
                ...
                <span style={{ fontSize:14, fontWeight:600, color:"#F0EAFC", lineHeight:1.4, wordBreak:"keep-all", flex:1, paddingRight:12 }}>{q}</span>
                ...
                <Link href="/" aria-label="묘연 홈으로" style={{ display:"flex", flexDirection:"column", alignItems:"center", gap:4, textDecoration:"none", color:"inherit" }}>
                    <div style={{ display:"flex", alignItems:"center", gap:10 }}>
                        ...
                        <span style={{
                            ...
                            background:`linear-gradient(90deg, ${GOLD} 0%, #F0EAFC 45%, ${LAV} 100%)`,
            ...
            <div style={{ position:"relative", zIndex:1, flex:1 }}>
                ...
                <section style={{ padding:"0 24px", textAlign:"center" }}>
                    ...
                    <motion.div initial={{ opacity:0, y:18 }} animate={{ opacity:1, y:0 }} transition={{ delay:0.5, duration:0.6 }}>
                        ...
                        <h1 className="tarot-serif" style={{ fontSize:28, fontWeight:700, lineHeight:1.42, marginBottom:14, letterSpacing:"-0.01em", wordBreak:"keep-all" }}>
                            <span style={{ color:"#F0EAFC" }}>그 사람의 마음속,</span><br />
                            <span style={{
                                background:"linear-gradient(90deg, #F0EAFC 0%, #C4B5FD 45%, #A78BFA 100%)",
                        ...
                        <button onClick={go} style={{
                            ...
                            background:"var(--tarot-btn-bg)", color:"#F0EAFC", fontSize:16, fontWeight:700,
                ...
                <section style={{ padding:"36px 24px 0" }}>
                    <motion.div initial={{ opacity:0 }} whileInView={{ opacity:1 }} viewport={{ once:true }}>
                        ...
                        <h2 className="tarot-serif" style={{ fontSize:21, fontWeight:700, color:"#F0EAFC", textAlign:"center", marginBottom:24, lineHeight:1.48, wordBreak:"keep-all" }}>
                            이런 생각<br />하고 계신가요?
                        </h2>
                    </motion.div>
                    ...
                    <div style={{ display:"flex", flexDirection:"column", gap:9 }}>
                        {[
                            ...
                            >
                                ...
                                <p style={{ fontSize:14, color:"#F0EAFC", margin:0, lineHeight:1.5, fontWeight:500, wordBreak:"keep-all" }}>{q}</p>
                            </motion.div>
                        ))}
                    </div>
                ...
                <section style={{ padding:"36px 24px 0" }}>
                    <motion.div initial={{ opacity:0 }} whileInView={{ opacity:1 }} viewport={{ once:true }}>
                        ...
                        <h2 className="tarot-serif" style={{ fontSize:20, fontWeight:700, color:"#F0EAFC", textAlign:"center", marginBottom:6, lineHeight:1.45 }}>
                            실제 결과 화면 미리보기
                        </h2>
                    ...
                    <motion.div initial={{ opacity:0 }} whileInView={{ opacity:1 }} viewport={{ once:true }} transition={{ delay:0.2 }}>
                        <button onClick={go} style={{
                            ...
                            background:`rgba(76,40,137,0.25)`,
                        ...
                        {[
                            ...
                            >
                                ...
                                <div style={{ marginBottom:12 }}>
                                    ...
                                    <p className="tarot-serif" style={{ fontSize:16, fontWeight:700, color:"#F0EAFC", margin:0, wordBreak:"keep-all" }}>
                                        {ch.title}
                                    </p>
                                </div>
                                ...
                                {ch.items.map((item, j)=>(
                                    <div key={j} style={{
                                        ...
                                        <span style={{ fontSize:13, color:"rgba(240,234,252,0.85)", lineHeight:1.6, wordBreak:"keep-all" }}>
                                            {item}
                                        </span>
                                    </div>
                                ))}
                ...
                <section style={{ padding:"36px 24px 0" }}>
                    <motion.div initial={{ opacity:0 }} whileInView={{ opacity:1 }} viewport={{ once:true }}>
                        ...
                        <h2 className="tarot-serif" style={{ fontSize:20, fontWeight:700, color:"#F0EAFC", textAlign:"center", marginBottom:6, lineHeight:1.45 }}>이런 리딩을 만나요</h2>
                        ...
                        {[
                            ...
                            >
                                ...
                                <div style={{
                                    ...
                                    <p style={{ fontSize:13.5, color:"rgba(240,234,252,0.9)", lineHeight:1.75, margin:0, wordBreak:"keep-all" }}>
                                        {r.text}
                                    </p>
                                </div>
                ...
                <section style={{ padding:"36px 24px 0" }}>
                    <motion.div initial={{ opacity:0 }} whileInView={{ opacity:1 }} viewport={{ once:true }}>
                        ...
                        <h2 className="tarot-serif" style={{ fontSize:20, fontWeight:700, color:"#F0EAFC", textAlign:"center", marginBottom:22, lineHeight:1.45 }}>
                    ...
                    <div style={{ display:"flex", flexDirection:"column", gap:10 }}>
                        ...
                        <div style={{
                            ...
                            <div>
                                ...
                                <p style={{ fontSize:15, fontWeight:700, color:"#F0EAFC", margin:0 }}>과거와 연결 고리</p>
                                <p style={{ fontSize:11.5, color:"rgba(240,234,252,0.45)", margin:"3px 0 0" }}>카드 2장 · 타로 해석</p>
                            </div>
                        ...
                        {/* 유료 */}
                        <div style={{
                            background:`linear-gradient(135deg, ${DP}0.22) 0%, rgba(21,13,48,0.3) 100%)`,
                            ...
                            <div style={{ display:"flex", alignItems:"flex-start", justifyContent:"space-between", marginBottom:14 }}>
                                <div>
                                    ...
                                    <p style={{ fontSize:15, fontWeight:700, color:"#F0EAFC", margin:0 }}>그 사람의 마음과 앞날의 흐름</p>
                                    <p style={{ fontSize:11.5, color:"rgba(240,234,252,0.45)", margin:"3px 0 0" }}>카드 5장 심층 풀이 + 스페셜 풀이 4가지 + 최종 메시지</p>
                                </div>
                                <div style={{ flexShrink:0, marginLeft:12 }}>
                                    <p style={{ fontSize:20, fontWeight:800, color:"#F0EAFC", margin:0 }}>3,900원</p>
                                </div>
                            </div>
                ...
                <section style={{ padding:"36px 24px 0" }}>
                    <motion.div initial={{ opacity:0 }} whileInView={{ opacity:1 }} viewport={{ once:true }}>
                        <h2 className="tarot-serif" style={{ fontSize:20, fontWeight:700, color:"#F0EAFC", textAlign:"center", marginBottom:20 }}>자주 묻는 질문</h2>
                    </motion.div>
                ...
                <section style={{ padding:"36px 24px 64px", textAlign:"center" }}>
                    <motion.div initial={{ opacity:0, y:14 }} whileInView={{ opacity:1, y:0 }} viewport={{ once:true }}>
                        ...
                        <h2 className="tarot-serif" style={{ fontSize:22, fontWeight:700, color:"#F0EAFC", marginBottom:10, lineHeight:1.5, wordBreak:"keep-all" }}>
                        ...
                        <button onClick={go} style={{
                            ...
                            background:"var(--tarot-btn-bg)", color:"#F0EAFC", fontSize:17, fontWeight:700,
                            cursor:"pointer", boxShadow:"var(--tarot-btn-shadow)",
                            letterSpacing:"-0.01em", fontFamily:"inherit",
                        }}>
                            ★ 지금 바로 리딩 시작하기
