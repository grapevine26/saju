...
JSON 포맷:\n
{
  ...
  "vsCards": [
    { "topic": "비교 주제 (예: 갈등 스타일)", "myTrait": "나의 성향 한 줄", "partnerTrait": "상대방 성향 한 줄", "explanation": "두 성향이 만나면 실제 연애에서 어떤 역학·충돌이 발생하는지 구체적으로 설명하되, 반드시 실제 대화 한 토막을 포함할 것 (예: 나영: \\"오늘 너무 힘들었어\\" / 혁준: \\"그럼 다음부턴 이렇게 해\\") — 대화 한 줄이 어떤 설명보다 체감이 크다 (최소 300자)" },
    ... (정확히 4개)
  ],
  ...
  "coupleType": {
    ...
    "natureMetaphor": "두 사람의 타고난 기질을 각각 자연물에 비유해 관계의 구조를 그려주는 오프닝 문단 (최소 250자). 예시 구조: '당신은 깊게 뿌리내린 큰 산의 기질입니다. 그 사람은 그 비탈에 피어나는 꽃의 기질이고요. 꽃은 산이 있어야 뿌리내리고, 산은 꽃이 있어야 생명을 얻습니다.' — 반드시 두 사람의 실제 사주 기질에 맞는 자연물(산·강·바다·햇살·바람·숲·불꽃·비 등)을 고를 것. 무토·을목 같은 사주 용어는 절대 쓰지 말고 자연 이미지로만",
