...
1. 분량: 각 content는 400~500자, 정확히 2문단. 무료가 길면 포만감이 생겨 결제 동기가 떨어진다 — 짧고 강하게.
...
JSON 포맷:\n
{
  ...
  "details": [
    ...
    { "title": "🧬 [성향] 사주로 읽는 우리의 연애 DNA와 소통 패턴", "subtitle": "...", "content": "각자의 사주 데이터로 읽는 성격 성향, 사랑 표현 방식, 소통 스타일의 차이와 충돌 지점. 오행/십성 용어 대신 애착 유형·표현 방식·갈등 대처 스타일 같은 심리학 언어로만 서술하고, '나'와 '상대방'을 각각 분석한 뒤 비교하여 서술 (400~500자·2문단)" }
  ]
}`;
};
