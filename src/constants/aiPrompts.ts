...
(출력 규칙: compatibilityDetails는 정확히 9개, 반드시 아래 순서 그대로. 각 항목의 "title"은 아래 제공된 문자열을 한 글자도 바꾸지 말고 그대로 복사할 것 — UI에 고정 노출되는 상품 구성이다. subtitle과 content만 새로 작성한다. "subtitle"은 본문의 핵심을 요약하며 호기심을 자극하는 한 줄로, 15~25자. vsCards는 정확히 4개)
...
JSON 포맷:\n
{
  ...
  "compatibilityDetails": [
    ...
    { "title": "💸 재물 시너지", "subtitle": "...", "content": "함께하면 돈이 불어날까 깎일까? 각자의 재물운과 합쳤을 때의 시너지/리스크를 구체적으로 분석 (최소 600자)" }
  ],
  "coupleType": {
